...
def FilteredCategoriesQuerySet():
    ...
    def fill_with_empty_categories_recoursively(category):
        subcategory_count = 0
        for cat in category_all:
            if cat.parent == category:
                subcategory_count += 1
                subcategory_count += fill_with_empty_categories_recoursively(cat)
    ...
    for cat in category_all:
        fill_with_empty_categories_recoursively(cat)
